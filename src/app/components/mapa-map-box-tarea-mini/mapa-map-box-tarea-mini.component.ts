...
@Component({
  selector: 'app-mapa-map-box-tarea-mini',
  templateUrl: './mapa-map-box-tarea-mini.component.html',
  styleUrls: ['./mapa-map-box-tarea-mini.component.css']
})
export class MapaMapBoxTareaMiniComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    container: 'mapa-mapbox-tarea-mini', // container id
