...
@Component({
  selector: 'app-mapa-map-box-itac-mini',
  templateUrl: './mapa-map-box-itac-mini.component.html',
  styleUrls: ['./mapa-map-box-itac-mini.component.css']
})
export class MapaMapBoxItacMiniComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    container: 'mapa-mapbox-itac-mini', // container id
